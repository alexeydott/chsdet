...
type
    ...
    protected
      ...
      //This allow multiple encoding of a language to share one frequency table
			function GetOrder(str: PAnsiChar): PRInt32; virtual; abstract;
...
//      function HandleData(const aBuf: PChar; aLen: PRUint32): eProbingState; virtual; abstract;
      ...
      procedure HandleOneChar(aStr: PAnsiChar;  aCharLen: PRUint32); virtual;
  ...
  (*no validation needed here. State machine has done that*)
  	protected
			function GetOrder(str: PAnsiChar): PRInt32; override;
    public
...
procedure TCharDistributionAnalysis.HandleOneChar(aStr: PAnsiChar;  aCharLen: PRUint32);
var
  order: integer;
begin
...
function TEUCTWDistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
begin
  if byte(str^) >= $c4 then
...
function TEUCKRDistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
begin
  if byte(str^) >= $b0 then
...
function TGB2312DistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
begin
...
function TBig5DistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
begin
...
function TSJISDistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
var
  order: PRInt32;
begin
...
function TEUCJPDistributionAnalysis.GetOrder(str: PAnsiChar): PRInt32;
begin
